...
const CreateGallery = () => {
  ...
  return (
    <div className="mx-auto rounded-lg shadow-lg flex items-center justify-between p-4">
      <div className="flex-1 flex flex-col gap-5">
        <div className="flex items-center justify-between">
          <button className="text-black text-6xl">
            <IoIosArrowBack />
          </button>

          <div className="flex flex-col items-center justify-center rounded-lg">
            {!file && (
              <div className="flex flex-col items-center justify-center rounded-lg bg-gray-50 px-24 py-4">
                <Image
        ...
        <div>
          <div className="group">
            <div className="flex items-center justify-center rounded-2xl bg-gray-50 overflow-hidden max-w-[7vw] py-5 border-4 border-transparent group-hover:border-yellow-500 group-hover:shadow-outline">
